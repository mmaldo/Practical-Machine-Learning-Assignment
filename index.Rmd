...
Next we'll predict on our validation set which we will submit for grading. I estimate the out of sample error will be in the 90-93% range in line with our testing set.
```{r}
